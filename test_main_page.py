...
def test_guest_cant_see_product_in_basket_opened_from_main_page(browser, main_page_url):
    page = BasePage(browser, main_page_url)
    page.open()
...
class TestLoginFromMainPage():
    def test_guest_can_go_to_login_page(self, browser, main_page_url):
        page = BasePage(browser, main_page_url)   # инициализируем Page Object, передаем в конструктор экземпляр драйвера и url адрес
